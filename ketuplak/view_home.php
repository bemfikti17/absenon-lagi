...
if (empty($kegiatan)){
	echo '<div class=jumbotron>
			<h1 class="display-3">Anda belum punya kegiatan</h1>
		  <a href="?pages=kegiatan"><button class="btn btn-success">Tambah Kegiatan</button></a>
		  </div>';
	...
	while ($smd->fetch()) {
	  ...
	  <p class="lead">
	    <a class="btn btn-primary btn-lg" href="?pages=atur_absen&lihat_id='.$id_kegiatan.'" role="button">Buat Rapat Sekarang!!</a>
	  </p>
	</div>';
	}
?>
